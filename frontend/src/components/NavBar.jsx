  ...
  return (
    <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-3 py-3 sm:p-4 flex items-center justify-between gap-2">
        ...
        <Link
          to="/"
          className="group flex min-w-0 items-center gap-2 sm:gap-3 hover:scale-105 transition-transform duration-200"
        >
        ...
        <div className="flex shrink-0 items-center gap-0.5 sm:gap-1">
          ...
          <Link
            to={"/problems"}
            className={`px-2 sm:px-4 py-2.5 rounded-lg transition-all duration-200
              ${
                isActive("/problems")
          ...
          <div className="ml-1 sm:ml-2 mt-1 sm:mt-2">
            <UserButton />
          </div>
        </div>
      </div>
